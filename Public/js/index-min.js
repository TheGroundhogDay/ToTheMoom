(function(f, h) {
	...
	$.extend(!0, a, {
		...
		clearWeatherAnimation: function(e) {
			...
			$.isEmptyObject(a.weatherAnimationView) || a.weatherAnimationView.fadeOut(1E3, function() {
...
(function(f, h) {
	...
	$.extend(!0, a, {
		...
		initGifLoadingView: function() {
			...
			c.style.width = "32px";
			c.style.height = "32px";
			c.src = staticServerURI + "img/loading.gif";
			a.appendChild(c);
...
var searchEngineLogoBox = $(".search-engine .search-logo"),
	...
	searchEngineLogoPath = staticServerURI + "img/";
(function(f, h) {
	var a = {},
		e = $("#search-engine"),
	...
	$.extend(!0, a, {
		...
		metaSearchUrl: "",
		logos: {
			google: staticServerURI + "img/google.png",
			baidu: staticServerURI + "img/baidu.png"
		},
		types: {
			baidu: "baidu",
			google: "google"
		...
		get_search_hint_list: function(d) {
			...
			case "bing":
				...
				break;
			case "google":
				b = a.google_search_hint_url, a.get_google_search_hint_list(b, d, "firefox")
			}
		},
		...
		get_haosou_search_hint_list_callback: function(d) {
			...
			d.s = [];
			for (var b = 0, c = d.result.length; b < c; b++) d.s[b] = d.result[b].word;
			a.handle_search_hint_list(d.s)
		},
		...
		onSuggestListChange: function() {
			var d = a.suggestView.find(".suggest-item");
			!$.isEmptyObject(d) && 0 >= d.length ? a.search_hint_hide() : $.isEmptyObject(d) || (a.search_hint_show(), d.on("mouseover mouseout click", function(d) {
		...
		change2Google: function(d) {
			...
			setTimeout(function() {
				searchEngineLogo.attr("src",  "/Public/img/blank.png")
			}, 70);
			setTimeout(function() {
				searchEngineLogo.attr("src",  "/Public/img/google.png")
			}, 180);
		...
		change2Baidu: function(d) {
			...
			setTimeout(function() {
				searchEngineLogo.attr("src",  "/Public/img/baidu.png")
			}, 180);
			setTimeout(function(a) {
				$.isEmptyObject(a) || a()
			}, 300, d)
		...
		change2MetaSearch: function(d) {
			...
			a.changeSearchModeImgView.attr("src",   "/Public/img/" + d)
		},
	...
	k.on("click focus blur enter input propertychange keydown", function(d) {
		if ("click" != d.type || a.searchInputViewFocus) if ("focus" == d.type) {
			...
			if (a.isOverInSearchLogo || a.isOverInSearchBtn || a.isOverInSuggest || a.isOverInMetaSearchBtn) return a.searchInputView.focus(), !1;
		...
		else a.searchInputViewFocus_isSys && (a.searchInputViewFocus_isSys = !1), a.searchInputView.focus()
	});
	q.on("mouseover mouseout", function(d) {
		"mouseover" == d.type ? a.isOverInSearchBtn = !0 : "mouseout" == d.type && (a.isOverInSearchBtn = !1)
	});
	c.on("mouseover mouseout", function(d) {
		"mouseover" == d.type ? a.isOverInSearchLogo = !0 : "mouseout" == d.type && (a.isOverInSearchLogo = !1)
	});
	l.on("submit", function(d) {
		if ("submit" == d.type) {
			d = k.val();
			if ("" != d) {
				var b = a.search_type,
	...
	searchEngineLogoBox.on("click mouseover mouseout", function(d) {
	...
	p.on("click mouseover mouseout", function(d) {
...
(function(f, h) {
	...
	$.extend(!0, a, {
			...
			if (!a.isLocked() || b !== h && (b.isSys === h || b.isSys)) {
				...
				c.animate({
					...
					c.animate({
						...
						a.unLockView();
						a.visible = !1;
						!$.isEmptyObject(b) && b.callback && b.callback()
					})
				})
			}
		},
		...
		loadSite: function(b) {
			for (var c = a.siteGroupView, e = 0, d = c.length; e < d; e++) {
				var l = b[e] || {
					siteVos: []
				},
					g = $(c.get(e));
				...
				for (var m = 1, k = g.length; m < k; m++) {
					...
					var h = f.find(".web-group-icon"),
						p = null,
						t = !0;
					$.isEmptyObject(n.logoResourceId) || (p = staticServerAPIURI + "/" + n.logoResourceId, t = !1);
					!_MyJS.browser.isIE || 8 < _MyJS.browser.ieVersion ? h.css("background-image", t ? "" : "url('" + p + "')") : h.css("filter", t ? "" : "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + p + "',sizingMethod='scale')");
		...
		onClassChange: function() {
			var b = a.classGroupBodyView,
				c = a.siteClasses;
			$.each(c, function() {
				$(this).on("click mouseover mouseout", function(c) {
					if ("click" == c.type) {
						c = $(this);
						...
						var did=c.attr("id").substr(12);
						$.post("/Home/Index/datam",{'did':did},function(data){
						var html='';
						// console.log(data);
						$.each(data,function(index,value){
							html+='<div class="web-group web-group-couple " id="web-group-'+value.id+'">';
							html+='<div class="web-group-head">';
							html+='<span class="title-font">'+value.name+'</span>';
							html+='</div>';
							html+='<div class="web-group-item web-group-item-head"></div>';
							$.each(value['list'],function(m,n){
							html+='<a class="web-group-item" target="_blank" href="'+n.url+'" rel="" title="'+n.name+'">';
							// html+="<div class='web-group-icon' style='background-image: url('"+n.image+"');'>";
							html+='<div class="web-group-icon" style="background-image: url(';
							html+=n.image;
							html+=');">';
							html+='</div>';
							html+='<span class="web-group-name">'+n.name+'</span>';
							html+='</a>';
							})
							html+='</div>';
						})
						$('#web-site-body').empty();
						$('#web-site-body').append( html );
					},'json')
						a.currentClass = c
		...
		onSiteChange: function() {
			a.contentView.find(".web-group-item").on("mouseover mouseout", function(a) {
		...
		classNextPage: function() {
			...
			} else c = (a.currentPage - 1) * a.pageSize, a.hideClasses(c, a.pageSize), b = 1;
			c = (b - 1) * a.pageSize;
		...
		classPrevPage: function() {
			...
			else b = Math.ceil(a.siteClasses.length / a.pageSize), c = (a.currentPage - 1) * a.pageSize;
			a.hideClasses(c, a.pageSize);
			c = (b - 1) * a.pageSize;
			a.showClasses(c, a.pageSize);
			a.currentPage = b;
		...
		hideClasses: function(b, c) {
			$.each(a.siteClasses.slice(b, b + c), function() {
				$(this).hide(0)
			})
		},
...
(function(f, h) {
	...
	c.on("click mouseover mouseout", function(a) {
		var b = $(this),
			c = b.find("img:first"),
			e = staticServerURI + "img/",
			k = "";
...
(function(f, h) {
	...
	$.extend(!0, a, {
		...
		getImgList: function(b) {
			...
			// 						d.src = staticServerURI + "/u/default_img/default_bgimg_preview.png";
			// 						d.setAttribute("my-bgimg-id", m.id);
			// 						d.setAttribute("my-bgimg-preview-resource-id", m.previewResourceId);
			// 						f.appendChild(d);
			...
			// 				}
			// 				c.append(l);
			// 				a.contentGroupView.find(".bg-item .bg-img").on("click", function(b) {
		...
		onClassChange: function() {
			...
			b.on("click mouseover mouseout", function(c) {
				if ("click" == c.type) {
		...
		cutBGImg: function(b) {
			...
			$.isEmptyObject(c) || (a.cutBGImging = !0, a.randBgLoading(1), a.applyBGImg(c, function() {
				a.removeSelectBG();
		...
		applyBGImg: function(a, b) {
			...
			// 		} else 
					// $(document.body).css("background-image", "url('/Public/img/6864c58e69fc4038bf765620a1cb8cb1.jpg')"), $(document.getElementById("bg-iframe")).remove();
					b && b()
				// }
			// })
		},
	...
	$(function() {
		a.contentView.bind("resize", function() {
	...
	$.extend(!0, a, {
		...
		onHeaderMenuClick: function(e) {
			...
			case "help-info":
				...
				c = function() {
					MyHelpInfo.helpPicLoaded || $("#help-info-pic").attr("src", staticServerURI + "img/function.png");
		...
		settingViewShow: function(e) {
			var c = a.currentView;
			if (c !== h || null !== c) a.viewSlideIng = !0, MyLoading.hide(), jQuery(document.body).css("overflow-y", "hidden"), $(".head-nav-item").hide(), $("#goup").show(), c.css("top", "-" + $(f).height() + "px"), c.show(), c.animate({
				top: "40px"
			}, 500, function() {
				a.viewSlideIng = !1;
				e && e()
	...
	$.extend(!0, a, {
		switchBtnObj: function(a, c) {
			...
			b.init = function() {
				...
				b.view.on("click mouseover mouseout", function(a) {
					if ("click" == a.type) {
						if (b.locked) return !0;
						b.locked = !0;
						b.isChecked ? b.uncheck() : b.check();
						b.callback ? b.callback(b.isChecked, function() {
							b.locked = !1
						}) : b.locked = !1
		...
		init: function() {
			MyUserCenter.initd || (MyUserCenter.getHobbyList(), MyUserCenter.getJobList(function(a) {
				...
				completeFunction: function(a) {
					...
					if ("undefined" !== typeof a) for (var b = 1, c = 0, e = a.length; c < e; c++) {
						var f = $(a[c]);
...
(function(f, h) {
	...
	g.on("click", function() {
		var b = l.val();
		try {
			b = $.trim(b), "" == b ? _MyJS.toast("\u8bf7\u8f93\u5165\uff01", 2E3, "red", "5px") : 15 > b.length ? _MyJS.toast("\u4e0d\u53ef\u4f4e\u4e8e15\u4e2a\u5b57\uff01", 2E3, "red", "5px") : (a.sendMail(b), l.val(""), _MyJS.toast("\u6211\u4eec\u5df2\u6536\u5230\u60a8\u7684\u53cd\u9988\uff01", 2E3, null, "5px"))
		} catch (k) {}
	});
	f.MyHelpInfo = a
})(window, void 0);
	...
	$.extend(!0, a, {
		...
		init: function() {
			...
			case Search_Engine.types.baidu:
				Search_Engine.search_type = Search_Engine.types.baidu, searchEngineLogo.attr("src", Search_Engine.logos.baidu)
			}
			a.view.fadeIn(100, function() {
				...
				NavSite.initView(function() {
					...
					0 >= $(f).scrollTop() && (c = !0);
					$(document.body).on("mousewheel DOMMouseScroll", function(a) {
						...
						else if (0 > a && !NavSite.isShow()) return NavSite.show(), !1
					});
...
$(function() {
	...
	BGSetting.applyBGImg(f, function(f) {
